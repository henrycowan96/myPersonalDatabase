...
import { Upload, ChevronRight, LogOut } from 'lucide-react-native';
...
export default function SetupStep3({ selectedProtocols, isProcessing, onBack, onUpload, onLogout }: SetupStep3Props) {
  const hasSelectedProtocols = Object.values(selectedProtocols).filter(v => v).length > 0;
      ...
      {!isProcessing && (
        <View style={styles.buttonRow}>
          ...
          <TouchableOpacity
            ...
            disabled={!hasSelectedProtocols}
          >
            <LinearGradient 
              colors={!hasSelectedProtocols ? ['#475569', '#334155'] : ['#7c3aed', '#4f46e5']} 
